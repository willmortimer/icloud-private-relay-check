...
<body class="min-h-screen bg-[#F5F5F7] dark:bg-[#1C1C1E] transition-colors duration-200 text-base">
    <div class="container mx-auto px-4 py-6 max-w-5xl">
        <div class="space-y-4">
            ...
            <!-- Results Card -->
            <div id="results" class="glass rounded-2xl p-6 shadow-lg mb-4">
            ...
            <div class="glass rounded-2xl p-6 shadow-lg">
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white mb-4">About iCloud Private Relay</h2>
                <div class="prose dark:prose-invert">
                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-4">iCloud Private Relay is an iCloud+ service that prevents websites from tracking your internet activity by:</p>
